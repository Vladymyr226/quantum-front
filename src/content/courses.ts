...
export const courses: Course[] = [
  {
    ...
    hero: {
      title: "Медіабаєр",
      subtitle:
        "Практичний курс по генерації трафіку,\nорієнтований на результат та ефективність",
  ...
  },
  {
    ...
    hero: {
      title: "Афілейт спеціаліст",
      subtitle:
        "Навчись працювати з оферами і партнерками\nта монетизуй трафік в десятки разів",
  ...
  },
  {
    ...
    hero: {
      title: "SMM спеціаліст",
      subtitle:
        "Курс для тих, хто хоче вести соцмережі\nпрофесійно і коштувати на ринку",
