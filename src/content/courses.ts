...
export const courses: Course[] = [
  {
    ...
    hero: {
      title: "Медіабаєр",
      subtitle:
        "Практичний курс по генерації\nтрафіку, орієнтований\nна результат та ефективність",
  ...
  },
  {
    ...
    hero: {
      title: "Афілейт спеціаліст",
      subtitle:
        "Навчись працювати з оферами\nі партнерками та монетизуй\nтрафік в десятки разів",
  ...
  },
  {
    ...
    hero: {
      title: "SMM спеціаліст",
      subtitle:
        "Курс для тих, хто хоче вести\nсоцмережі професійно\nі коштувати на ринку",
